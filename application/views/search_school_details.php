        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <?php
                    if(!empty($school)) {
                ?>
                    <h1 style="font-size:26px; font-weight:bold;">School: <?php echo $school['name']; ?></h1><br>
                    <table class="table table-striped">
                      <tbody> 
                        ...
                        <tr>
                            <td> Number Of Students: <strong><?php echo $count; ?> </strong></td>
                        </tr>
                      </tbody>
                    </table>
                <?php
                ...
                <br>
                <br>
                <h1 style="font-size:26px; font-weight:bold;">Locate Us On The Map:</h1><br>
                <?php echo $map['js']; ?>
                <?php echo $map['html']; ?>
                <div class="hr-line-dashed"></div>
                 
                <div style="margin-top:30px;">
                <h1 style="font-size:26px; font-weight:bold;">Statistics</h1><br>
