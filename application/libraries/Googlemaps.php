...
class Googlemaps {
	...
	var $center						= "0.3137471, 32.58107189";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
